# Dougie Jones: Can see the the next card and plays accordingly. {psychic}
# Eddie O'Shea: Hits too riskily. {dealer, tolerance = 19}
# The Duchess: Plays like the dealer, has a lot of money and bets big. {dealer, money 3, wager 3}
# Shy Ronnie: Hit too cautiously. {dealer, tolerance 12}
# Kevin Keebler: Counts cards. {counting}
# Tommy Robbie and Jason: Three kids in a trenchcoat. Don't know how to play and hit randomly.
...
{:name : "Kevin Keebler" , :behavior : :countscards , :wager : 1, :money : 10, :flavor_text : "A mathy looking guy, they say he dropped out of MIT. Doesn't talk at all, as he seems too focused on everyone's cards."}
]
