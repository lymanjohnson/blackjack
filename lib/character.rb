...
# {:name => "Eddie O'Shea" , :behavior => :risky , :wager => 2, :money => 20, :flavor_text => "Always quick with a joke and a laugh. The jokes are often repeated and his laugh seem seems forced, though. He keeps looking over his shoulder."},
...
# {:name => "Kevin Keebler" , :behavior => :countscards , :wager => 1, :money => 10, :flavor_text => "MIT dropout. He seems extremely focused on everyone else's cards."}
# ]
