...
eddie = Character.new("Eddie O'Shea",:risky ,2,20,"Always quick with a joke and a laugh. The jokes are often repeated and his laugh seems forced, though. He keeps looking over his shoulder.","A risky player with a high tolerance for risk")
...
$characters = [eddie,duchess,tommy_robby_jason]
